...
/*
        //Task 2
        //Небольшой комментарий к задаче в виду того, что я не доконца понял условия попадания на окружность.
        //Написал программу исходя из того, что попасть на окружность можно при условии, если одна координата будет
